...
// source: carstatus.proto
// Protobuf C++ Version: 6.31.1

#ifndef carstatus_2eproto_2epb_2eh
#define carstatus_2eproto_2epb_2eh
...
#define PROTOBUF_INTERNAL_EXPORT_carstatus_2eproto
...
struct TableStruct_carstatus_2eproto {
  static const ::uint32_t offsets[];
};
extern "C" {
extern const ::google::protobuf::internal::DescriptorTable descriptor_table_carstatus_2eproto;
}  // extern "C"
namespace example {
class SimpleMessage;
struct SimpleMessageDefaultTypeInternal;
extern SimpleMessageDefaultTypeInternal _SimpleMessage_default_instance_;
extern const ::google::protobuf::internal::ClassDataFull SimpleMessage_class_data_;
}  // namespace example
namespace google {
namespace protobuf {
}  // namespace protobuf
...
/* @@protoc_insertion_point(class_definition:example.SimpleMessage) */ {
 public:
  ...
  void operator delete(SimpleMessage* PROTOBUF_NONNULL msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  inline void Swap(SimpleMessage* PROTOBUF_NONNULL other) {
  ...
  void UnsafeArenaSwap(SimpleMessage* PROTOBUF_NONNULL other) {
    if (other == this) return;
  ...
  SimpleMessage* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
  ...
  void InternalSwap(SimpleMessage* PROTOBUF_NONNULL other);
 private:
  template <typename T>
 ...
 protected:
  explicit SimpleMessage(::google::protobuf::Arena* PROTOBUF_NULLABLE arena);
  SimpleMessage(::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const SimpleMessage& from);
  SimpleMessage(
      ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, SimpleMessage&& from) noexcept
      : SimpleMessage(arena) {
    *this = ::std::move(from);
  }
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_carstatus_2eproto;
};
...
PROTOBUF_ALWAYS_INLINE void SimpleMessage::set_sender_name(Arg_&& arg, Args_... args) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
...
inline ::std::string* PROTOBUF_NONNULL SimpleMessage::mutable_sender_name()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline ::std::string* PROTOBUF_NONNULL SimpleMessage::_internal_mutable_sender_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_._has_bits_[0] |= 0x00000001u;
  return _impl_.sender_name_.Mutable( GetArena());
}
inline ::std::string* PROTOBUF_NULLABLE SimpleMessage::release_sender_name() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
...
inline void SimpleMessage::set_allocated_sender_name(::std::string* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (value != nullptr) {
    _impl_._has_bits_[0] |= 0x00000001u;
  } else {
...
#endif  // carstatus_2eproto_2epb_2eh
